...
{
    public Task<bool> CheckPasswordAsync(IUser user, string password) => Task.FromResult(true);
    public Task<IdentityResult> CreateAsync(IUser user, string password) => Task.FromResult(IdentityResult.Success);
